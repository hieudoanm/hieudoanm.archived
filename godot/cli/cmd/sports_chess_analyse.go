...
// sportsChessAnalyseCmd represents the analyse command
var sportsChessAnalyseCmd = &cobra.Command{
	Use:   "analyse",
...
func init() {
	sportsChessCmd.AddCommand(sportsChessAnalyseCmd)
	sportsChessAnalyseCmd.PersistentFlags().String("fen", "", "Forsyth-Edwards Notation")

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// sportsChessAnalyseCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// sportsChessAnalyseCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
