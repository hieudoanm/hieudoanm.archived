...
| Hardware | Python                 | Mini Computer   |                                      | [Raspberry PI](https://www.raspberrypi.com/)                                                         |      |
...
| Software | [Docker][docker]       | Database        | Key-Value                            | [Memcached](https://hub.docker.com/_/memcached)                                                      |      |
| Software | [Docker][docker]       | Database        | Key-Value                            | [Redis](https://hub.docker.com/_/redis)                                                              |      |
| Software | [Docker][docker]       | Database        | Wide Column                          | [cassandra](https://hub.docker.com/_/cassandra)                                                      |      |
| Software | [Docker][docker]       | Database        | Document Oriented                    | [mongo](https://hub.docker.com/_/couchdb)                                                            |      |
| Software | [Docker][docker]       | Database        | Document Oriented                    | [mongo](https://hub.docker.com/_/mongo)                                                              |      |
| Software | [Docker][docker]       | Database        | Relational                           | [cockroachdb](https://hub.docker.com/r/cockroachdb/cockroach)                                        |      |
| Software | [Docker][docker]       | Database        | Relational                           | [mysql](https://hub.docker.com/_/mysql)                                                              |      |
| Software | [Docker][docker]       | Database        | Relational                           | [postgres](https://hub.docker.com/_/postgres)                                                        |      |
| Software | [Docker][docker]       | Database        | Graph                                | [dgraph](https://hub.docker.com/r/dgraph/dgraph)                                                     |      |
| Software | [Docker][docker]       | Database        | Graph                                | [neo4j](https://hub.docker.com/_/neo4j)                                                              |      |
| Software | [Docker][docker]       | Database        | Search Engine                        | [elasticsearch](https://hub.docker.com/_/elasticsearch)                                              |      |
| Software | [Docker][docker]       | Database        | Search Engine                        | [elasticsearch](https://hub.docker.com/_/solr)                                                       |      |
| Software | [Docker][docker]       | Database        | Multi-Model                          | [faunadb](https://hub.docker.com/r/fauna/faunadb)                                                    |      |
| Software | [Docker][docker]       | OS              | Linux                                | [Alpine](https://hub.docker.com/_/alpine)                                                            |      |
| Software | [Docker][docker]       | OS              | Linux                                | [Ubuntu](https://hub.docker.com/_/ubuntu)                                                            |      |
| Software | [Docker][docker]       | Server          |                                      | [nginx](https://hub.docker.com/_/nginx)                                                              |      |
| Software | [Docker][docker]       | Runtime         | Golang                               | [Golang](https://hub.docker.com/_/golang/)                                                           |      |
| Software | [Docker][docker]       | Runtime         | Java                                 | [OpenJDK](https://hub.docker.com/_/openjdk)                                                          |      |
| Software | [Docker][docker]       | Runtime         | JavaScript                           | [Node.js](https://hub.docker.com/_/node/)                                                            |      |
| Software | [Docker][docker]       | Runtime         | Python                               | [Python](https://hub.docker.com/_/python/)                                                           |      |
