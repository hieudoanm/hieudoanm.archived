...
| Group     | Subgroup      | [AWS][aws]                      | Azure | Google Cloud |
| --------- | ------------- | ------------------------------- | ----- | ------------ |
| Container | Registry      | [ECR][aws-ecr]                  |       |              |
| Container | Kubernetes    | [EKS][aws-eks]                  |       |              |
| Database  | Key-Value     | [ElasticCache][aws-elasticache] |       |              |
| Database  | Relational    | [RDS][aws-rds]                  |       |              |
| Database  | Search Engine | [OpenSearch][aws-opensearch]    |       |              |
| Files     | Block Storage | [EBS][aws-ebs]                  |       |              |
