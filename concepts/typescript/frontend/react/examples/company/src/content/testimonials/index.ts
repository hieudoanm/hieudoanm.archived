...
export const testimonials = [
  ...
  },
  {
    id: 2,
    logo: google,
    author: 'By Davie Foster, Adviser of Facebook',
    quote:
      `“Qwilr Page we have made for them. Whatever we create in Qwilr looks absolutely brilliant. It helps show our work in the best light, and is downright impressive when clients see a”`
  },
  {
    id: 3,
    logo: paypal,
    author: 'By London Myla, Adviser of Paypal',
    quote:
      `“Whatever we create in Qwilr looks absolutely brilliant. It helps show our work in the best light, and is downright impressive when clients see a Qwilr Page we have made for them.”`
  },
  {
    id: 4,
    logo: microsoft,
    author: 'By Mikey Cherilyn, Adviser of Paypal',
    quote:
      `“Qwilr Page we have made for them. Whatever we create in Qwilr looks absolutely brilliant. It helps show our work in the best light, and is downright impressive when clients see a”`
  },
  {
    id: 5,
    logo: dribbble,
    author: 'By Gloria Kristi, Adviser of Paypal',
    quote:
      `“Whatever we create in Qwilr looks absolutely brilliant. It helps show our work in the best light, and is downright impressive when clients see a Qwilr Page we have made for them.”`
  }
];
