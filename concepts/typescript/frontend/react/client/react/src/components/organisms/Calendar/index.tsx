...
const Day: React.FC<DayProps> = ({
  ...
  if (year !== currentYear) {
    return (
      <div className="px-2 text-right text-black/50">
      ...
      <div className="hidden border-t md:block">
        <div className="grid grid-cols-7">
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Sunday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Monday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Tuesday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Wednesday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Thursday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Friday</p>
          </div>
          <div className="col-span-1">
            <p className="p-4 text-center font-medium">Saturday</p>
          </div>
        </div>
      </div>
