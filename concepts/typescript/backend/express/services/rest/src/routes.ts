...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    function ListsController_getLists(request: any, response: any, next: any) {
      const args = {};
      ...
      try {
        ...
        const promise = controller.getLists.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function ListsController_getList(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.getList.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function ListsController_createList(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.createList.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function ListsController_updateList(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updateList.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.delete(
    ...
    function ListsController_deleteList(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.deleteList.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function TasksController_getTasks(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.getTasks.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.post(
    ...
    function TasksController_createTask(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.createTask.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function TasksController_getTask(request: any, response: any, next: any) {
      ...
      try {
        ...
        const promise = controller.getTask.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function TasksController_updateTask(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updateTask.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.delete(
    ...
    function TasksController_deleteTask(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.deleteTask.apply(
          controller,
          validatedArgs as any
        );
  ...
  app.patch(
    ...
    ...fetchMiddlewares<RequestHandler>(UsersController),
    ...fetchMiddlewares<RequestHandler>(UsersController.prototype.updateEmail),
    function UsersController_updateEmail(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updateEmail.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function UsersController_updateUsername(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updateUsername.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.patch(
    ...
    function UsersController_updatePassword(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.updatePassword.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.delete(
    ...
    function UsersController_deleteUser(
      request: any,
      response: any,
      next: any
    ) {
