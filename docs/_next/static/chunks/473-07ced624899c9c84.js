  ...
  [473],
  {
    ...
    9860: (e, t, r) => {
      ...
      let _ = u.default.forwardRef(function (e, t) {
        ...
        let w = u.default.useContext(s.RouterContext),
          I = !1 !== j,
          { href: S, as: T } = u.default.useMemo(() => {
            ...
            let [e, t] = (0, o.resolveHref)(w, a, !0);
            return { href: e, as: h ? (0, o.resolveHref)(w, h) : t || e };
          }, [w, a, h]),
          U = u.default.useRef(S),
          D = u.default.useRef(T);
        ...
        u.default.useEffect(() => {
          w && N && I && v(w, S, T, { locale: P });
        }, [T, S, N, P, I, null == w ? void 0 : w.locale, w]);
        let B = {
          ref: z,
          onClick(e) {
        ...
        else if (!x || M || ('a' === n.type && !('href' in n.props))) {
        ...
        return x
          ? u.default.cloneElement(n, B)
          : (0, l.jsx)('a', { ...L, ...B, children: r });
      });
      ('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
