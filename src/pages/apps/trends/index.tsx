            ...
            <Link key={query} href={url} target='_blank' className='block'>
              <Badge>
                <div className='flex items-center justify-between gap-x-2'>
                  <div>{query}</div>
                  <div className='bg-base-content inline-block h-4 w-4 rounded-full text-center text-[8px] leading-4 text-black'>
                    {count}
                  </div>
                </div>
              </Badge>
        ...
        <div className='p-4 md:p-8'>
          <div className='flex flex-col gap-8'>
            <div className='join join-vertical w-full'>
              <div className='join-item collapse-arrow border-base-content collapse border'>
