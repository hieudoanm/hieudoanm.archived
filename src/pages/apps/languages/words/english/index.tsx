        ...
        return (
          <div
            ...
            derivation.length > 0 ? (
              <div
                role='tablist'
                className='tabs tabs-lifted border-primary-content rounded-xl'>
                <Tab
                  title='Synonyms'
                  list={synonyms}
                  index={index}
  ...
  return (
    <div className='flex flex-col gap-y-8'>
      {status === 'pending' ? (
        ...
        <>
          {error ? (
            <div className='border-primary-content flex w-full items-center justify-center rounded-xl border p-8'>
              {error?.message ?? 'Error'}
            </div>
          ) : (
            <>
