...
const Key: FC<{ latin: string; hangul: string; shift?: string }> = ({
  ...
  return (
    <div className='border-base-content relative aspect-square w-full rounded-lg border'>
      <div className='absolute top-1 left-2'>{latin}</div>
      <div className='absolute bottom-1 left-2'>{hangul}</div>
      <div className='absolute top-1 right-2'>{shift}</div>
    </div>
  );
};
