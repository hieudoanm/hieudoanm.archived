  ...
  return (
    <div className='overflow-hidden'>
      <div className='flex flex-col gap-y-4 md:gap-y-8'>
        ...
        <div className='border-base-content overflow-x-auto rounded-lg border'>
          <table className='table'>
            <thead>
              <tr>
                {[0, 1, 2, 3, 4, 5, 6].map((day: number) => {
                  return (
                    <th key={day} className='border-base-content border-b'>
                      ...
                      ({ year: dateYear, month: dateMonth, date, current }) => {
                        ...
                        return (
                          <td
                            ...
                            className='border-base-content border-b text-center'>
