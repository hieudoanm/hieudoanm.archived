        ...
        <div className="grid grid-cols-5 md:grid-cols-7 lg:grid-cols-9">
          <div className="col-span-2 md:col-span-3 lg:col-span-4">
            <div className="flex justify-center items-center w-full h-full">
              <div className="w-full h-full px-2 py-4 bg-[#5CAB40]">
                <Sprite
                  image="https://raw.githubusercontent.com/hieudoanm/cdn/master/images/football-battle/svg/stake-to-play/player-card.svg"
          ...
          <div className="col-span-1">
            <div className="flex justify-center items-center w-full h-full">
              <div>
                <Sprite
                  image="https://raw.githubusercontent.com/hieudoanm/cdn/master/images/football-battle/svg/stake-to-play/play.svg"
